...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidSlotException(
    ...
    @ExceptionHandler(SlotAlreadyHeldException.class)
    public ResponseEntity<ErrorResponse> handleSlotAlreadyHeldException(
            SlotAlreadyHeldException ex,
            HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleHoldNotFoundException(
    ...
    public ResponseEntity<ErrorResponse> handleHoldOwnershipException(
            HoldOwnershipException ex,
            HttpServletRequest request) {
    ...
    //Duplicate booking race -> 500 Internal Server Error
    //With this handler
    //Duplicate booking race -> 409 Conflict
